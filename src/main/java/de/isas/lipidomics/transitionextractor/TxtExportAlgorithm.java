 ...
 * {@link io.github.msdk.datamodel.MsSpectrum} objects to string representations
 * or files.
 * </p>
 */
@Slf4j
public class TxtExportAlgorithm {
    ...
    public static void exportSpectra(@Nonnull File exportFile,
            @Nonnull Collection<? extends MsSpectrum> spectra) throws IOException {
        exportSpectra(exportFile, spectra, " ",
                new Function<MsSpectrum, String>() {
            @Override
            public String apply(MsSpectrum t) {
                return TxtExportAlgorithm.spectrumToString(t);
            }
        });
    }
     ...
     */
    public static void exportSpectra(@Nonnull File exportFile,
            @Nonnull Collection<? extends MsSpectrum> spectra,
            @Nonnull String delimiter,
            @Nonnull Function<MsSpectrum, String> mapper) throws IOException {
...
//                        writer.newLine();
    ...
    String spectrumToString(@Nonnull MsSpectrum spectrum) {
